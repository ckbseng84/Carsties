...
export default function BidItem({bid}: Props) {
  ...
  return (
    <div
        className={`
            border-gray-200 border-2 px-3 py-2 rounded-lg
    ...
    >
        <div className='flex flex-col'>
            ...
            <span className="text-gray-700 text-sm" >Time: {format(bid.bidTime,'dd MMMM yyyy h:mm a')}</span>
        </div>
        <div>
